...
df = pd.read_csv(r"C:\Users\user\OneDrive\Desktop\My Projects\House Price Prediction\Data\Bengaluru_House_Data.csv")
...
st.subheader("Predict the house price based on your requirenments.")
